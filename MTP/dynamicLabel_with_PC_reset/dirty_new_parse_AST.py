...
def if_denning(G,called_by_fun, fun_global, if_str, rest, PC):
    ...
    if "orelse=" not in if_str:
        ...
        if if_str[0:2] == "[]":  # absence of else part
            ...
            else_str = if_str
            continuous_parse(called_by_fun, fun_global, else_str, PC[:])
            return []
...
def fun_denning(fun_str,PC):
    ...
    return continuous_parse(G, fun_name, fun_globals, fun_str)
...
def continuous_parse(G,called_by_fun, fun_global, data, PC):
    #pdb.set_trace()
    ...
    while i < length - 1:
        ...
        if parse_keyword(i,data) == "Expr(value=Call(func=Name(id='":
            ...
            i = parse_parenthesis(i+4, data)[1]
            pass
