...
def if_denning(if_str):
    ...
    S1 = susr_continuous_parse("",{},body_str)
    S2 = susr_continuous_parse("",{},ladder)
<<<<<<< HEAD
    Su = S1[0] + S2[0]
    Sr = S1[1] + S2[1]
=======
...
>>>>>>> f80aee3b54ec3d9c7c43634659ef4c3348993fb0
    #print S2,ladder
...
<<<<<<< HEAD
        ...
        Sr += Slist[i][1]
        if i < len(Slist) - 1:
            print "Verify seq:", make_lub_string(Slist[i][1]), "<=", print_su_list(Slist,i+1)
=======
        if not Slist[i]:
            i += 1
            continue
...
>>>>>>> f80aee3b54ec3d9c7c43634659ef4c3348993fb0
    ...
    # print globals
    fun_global_while = []
    susr_continuous_parse(fun_name, fun_globals, fun_str)

supreme_global = {}

def susr_continuous_parse(called_by_fun,fun_global,data):
    S = []
    count = 0
    global PCLabel
...
>>>>>>> f80aee3b54ec3d9c7c43634659ef4c3348993fb0
            ...
            i = tmp[1]
<<<<<<< HEAD
            set_clear_denning(called_by_fun, fun_global, expr_str)
